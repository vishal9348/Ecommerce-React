                    ...
                    lg:pb-24">
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <div className='flex space-x-5 items-center text-lg lg:text-xl text-gray-900 mt-6'>
                                ...
                                <p className='text-gray-600 font-semibold'>10% off</p>
                            </div>
                            ...
                            <div className="mt-6">
                                <div className='flex item-center space-x-3'>
                                    ...
                                    <p className='opacity-50 text-sm'>56490 Rating</p>
                                    <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500'>3648 Reviews</p>
                                </div>
                            </div>
                        ...
                        <Grid container spacing={7}>
                            <Grid item xs={7}>
                                <div className='space-y-5'>
                                    {[1,1,1].map((item)=> <ProductReviewsCard/>)}
                                </div>
                            </Grid>
                            ...
                            <Grid item xs={5}>
                                ...
                                <div className='flex item-center'>
                                    ...
                                    <p className='opacity-60'>567934 Ratings</p>
                                </div>
